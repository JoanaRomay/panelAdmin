          ...
          <div className="h-40 w-[50rem] bg-amber-50 rounded-xl mt-10">
            ...
            <div className="flex items-center justify-between mt-5">
              <button
                ...
                className="bg-gray-300 hover:bg-gray-400 text-gray-800 font-bold py-5 w-[23rem] rounded-lg ml-5"
              >
                + Nuevo Producto
              </button>
              <button
                className="bg-gray-300 hover:bg-gray-400 text-gray-800 font-bold py-5 w-[23rem] rounded-lg mr-5"
              >
                Ver Pedidos
              </button>
            </div>
